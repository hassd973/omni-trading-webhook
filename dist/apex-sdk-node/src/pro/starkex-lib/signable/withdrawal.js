...
class SignableWithdrawal extends stark_signable_1.StarkSignable {
    static fromWithdrawalWithClientId(withdrawal, networkId, asset) {
        ...
        return SignableWithdrawal.fromWithdrawalWithNonce(Object.assign(Object.assign({}, withdrawal), { clientId: undefined, nonce }), networkId, asset);
    }
    ...
    calculateHash() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, crypto_1.getPedersenHash)(yield (0, crypto_1.getPedersenHash)((0, util_1.hexToBn)((0, constants_1.COLLATERAL_ASSET_ID_BY_NETWORK_ID)()), ethAddressBN), packedWithdrawalBn);
        });
    }
    toStarkware() {
        return this.message;

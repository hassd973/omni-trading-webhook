...
class SignableConditionalTransfer extends stark_signable_1.StarkSignable {
    ...
    calculateHash() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const assetIds = yield (0, hashes_1.getCacheablePedersenHash)((0, util_1.hexToBn)((0, constants_1.COLLATERAL_ASSET_ID_BY_NETWORK_ID)()), constants_2.TRANSFER_FEE_ASSET_ID_BN);
            const transferPart1 = yield (0, lib_1.getPedersenHash)(yield (0, lib_1.getPedersenHash)(assetIds, receiverPublicKeyBn), conditionBn);
            ...
            return (0, lib_1.getPedersenHash)(yield (0, lib_1.getPedersenHash)(transferPart1, transferPart2), transferPart3);
        });
    }
    toStarkware() {
        return this.message;

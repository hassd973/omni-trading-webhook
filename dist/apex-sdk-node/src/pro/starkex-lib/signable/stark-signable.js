import { asEcKeyPair, asEcKeyPairPublic, asSimpleSignature, deserializeSignature, serializeSignature, } from '../helpers';
...
export class StarkSignable {
    ...
    async verifySignature(signature, publicKey, publicKeyYCoordinate = null) {
        ...
        const hashBN = await this.getHashBN();
        return ((await verify(asEcKeyPairPublic(publicKey, false), hashBN, signatureStruct)) ||

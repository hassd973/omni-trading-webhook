...
class SignableOrder extends stark_signable_1.StarkSignable {
    static fromOrderWithClientId(order, networkId) {
        ...
        return SignableOrder.fromOrderWithNonce(Object.assign(Object.assign({}, order), { clientId: undefined, nonce }), networkId);
    }
    ...
    calculateHash() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const assetsBn = yield (0, hashes_1.getCacheablePedersenHash)(yield (0, hashes_1.getCacheablePedersenHash)(assetIdSellBn, assetIdBuyBn), assetIdFeeBn);
            const hash = yield (0, lib_1.getPedersenHash)(yield (0, lib_1.getPedersenHash)(assetsBn, orderPart1), orderPart2);
            return hash;
        });
    }
    toStarkware() {

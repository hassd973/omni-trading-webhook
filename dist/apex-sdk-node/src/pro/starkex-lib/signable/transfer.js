...
class SignableTransfer extends stark_signable_1.StarkSignable {
    ...
    calculateHash() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transferPart1 = yield (0, crypto_1.getPedersenHash)(assetIds, receiverPublicKeyBn);
            ...
            return (0, crypto_1.getPedersenHash)(yield (0, crypto_1.getPedersenHash)(transferPart1, transferPart2), transferPart3);
        });
    }
    toStarkware() {
        return this.message;

...
const { API_KEY, SECRET, PASSPHRASE, ETH_PRIVATE_KEY, ACCOUNT_ID, OMNI_SEED, L2KEY, CHAIN_ID = '42161', API_URL, NODE_ENV } = process.env;
...
app.post('/webhook', async (req, res) => {
    try {
        ...
        const orderRes = await apexClient.privateApi.createOrder(orderParams.symbol, orderParams.side, orderParams.type, orderParams.size, orderParams.timeInForce, orderParams.price, orderParams.clientOrderId, orderParams.maxFeeRate);
